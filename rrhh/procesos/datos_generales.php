      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="exampleInputEmail1">Peso maximo para ODI</label>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="exampleInputEmail1">Peso maximo para competencias</label>
          ...
          <div class="clearfix visible-md-block"></div>
          <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="exampleInputEmail1">Rango maximo para ODI</label>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="exampleInputEmail1">Rango maximo para competencias</label>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="exampleInputEmail1">Fecha de apertura para ODI</label>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="exampleInputEmail1">Fecha de cierre para ODI</label>
