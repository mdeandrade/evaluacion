...
<div class="container">
	...
	<a class="btn btn-success"  href="<?php echo full_url."/rrhh/personal/index.php?action=new"?>"><i class="fa fa-file-o fa-pull-left fa-border"></i> Agregar</a>
</div>
...
$(document).ready(function() {
	...
	$('#example tfoot th').each( function () {
		...
		if(title == 'Detalle')
		{
			$(this).html( '<button id="">Evaluacion</button>' );	
		}
