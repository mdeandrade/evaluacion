    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
              <li><a href="<?php echo full_url?>/rrhh/usuarios/index.php?action=index">ODI asignados</a></li>
          </ul>
        </li>
      </ul>
      <ul class="nav navbar-nav">
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-cogs"></i> Evaluaciones <span class="caret"></span></a>
          <ul class="dropdown-menu">
              <li><a href="<?php echo full_url?>/rrhh/procesos/index.php?action=index">Listado de Evaluacion</a></li>
          </ul>
        </li>
      </ul>
      <ul class="nav navbar-nav">
