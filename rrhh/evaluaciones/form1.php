...
<h1 class="text-center">Evaluación Nivel Técnico Profecional </h1>
...
<div>
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation"><a href="#evaluacion_pro_tec" aria-controls="evaluacion_pro_tec" role="tab" data-toggle="tab">Técnico Profecional</a></li>
  </ul>

  <!-- Tab panes -->
  <div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="evaluacion_pro_tec"><?php require('evaluacion_pro_tec.php');?></div>
  </div>

</div>
           <button type="submit" id="guardar" class="btn btn-success">Guardar</button>

    <a class="btn btn-default" href="<?php echo full_url?>/rrhh/evaluaciones/index.php?action=Pro">Regresar</a>
